  ...
  return (
    <section>
        <div className='p-2 bg-white shadow-md flex items-center justify-between'>
            ...
            <button className='text-sm border border-[#ffbf00] hover:bg-[#ffbf00] px-3 py-1 rounded' onClick={()=>setOpenCategory(true)}>Add Category</button>
        </div>
        {
        ...
        {
          openCategory && (
            <UploadCategoryModel fetchData={fetchCategory} close={()=>setOpenCategory(false)}/>
          )
        }
